export function RenovationVisualizerIllustration({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 280 180" fill="none" aria-hidden="true" className={className} style={{ width: "100%", height: "100%", display: "block" }}>
      <rect x="10" y="20" width="125" height="140" rx="8" fill="rgba(14,18,24,0.03)" stroke="rgba(14,18,24,0.07)" strokeWidth="1" />
      ...
      <text x="42" y="34" fontFamily="JetBrains Mono, monospace" fontSize="6" fill="#9AA1B0" letterSpacing="1">BEFORE</text>
      <g stroke="#9AA1B0" strokeWidth="1.2" opacity="0.4">
      ...
      <text x="183" y="34" fontFamily="JetBrains Mono, monospace" fontSize="6" fill="#C26A3B" letterSpacing="1">AFTER</text>
    </svg>
  );
}
