export function BriefRendersIllustration({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 280 140" fill="none" aria-hidden="true" className={className} style={{ width: "100%", height: "100%", display: "block" }}>
      <rect x="30" y="20" width="60" height="80" rx="4" fill="white" stroke="rgba(14,18,24,0.14)" strokeWidth="1" />
      <line x1="40" y1="35" x2="80" y2="35" stroke="#9AA1B0" strokeWidth="1" opacity="0.4" />
      <line x1="40" y1="42" x2="75" y2="42" stroke="#9AA1B0" strokeWidth="1" opacity="0.3" />
      <line x1="40" y1="49" x2="78" y2="49" stroke="#9AA1B0" strokeWidth="1" opacity="0.3" />
      ...
      <g stroke="#9AA1B0" strokeWidth="1.2" opacity="0.5">
