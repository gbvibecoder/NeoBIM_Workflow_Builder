...
// ─── estimateCosts — REMOVED (Phase E.4 dead code cleanup) ──────────────────
// Superseded by IS 1200 / CPWD DSR rate library + market intelligence pipeline.
// See git history for the original GPT-4o-mini QS estimation function.
