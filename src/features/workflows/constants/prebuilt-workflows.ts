...
export const PREBUILT_WORKFLOWS: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    description:
      "Enter a text prompt → get a professional interactive floor plan with walls, doors, windows, room schedule, and BOQ — fully editable in the built-in CAD editor.",
    tags: ["floor-plan", "ai", "layout", "architecture", "quick-start", "cad", "editor", "interactive"],
    category: "Concept Design",
    complexity: "simple",
    estimatedRunTime: "~30 seconds",
    requiredInputs: ["Text description of building program"],
    expectedOutputs: ["Building description", "Interactive floor plan (editable)", "Room schedule", "BOQ quantities", "SVG drawing"],
    thumbnail: "/floor-plan-editor-preview.png",
    tileGraph: {
      nodes: [
        {
          id: "n1",
      ...
      edges: [
        ...
        { id: "e2-3", source: "n2", sourceHandle: "prog-out", target: "n3", targetHandle: "json-in", type: "animatedEdge" },
      ],
    },
  },
  {
    id: "wf-06",
    name: "Floor Plan → Render + Video Walkthrough",
    description:
  ...
  },
  {
    ...
    thumbnail: "/boq-cost-estimate-preview.png",
    tileGraph: {
      nodes: [
        {
          id: "n1",
  ...
  {
    id: "wf-03",
    name: "Text Prompt → 3D Building + IFC Export",
    description:
    ...
    expectedOutputs: ["Building description", "3D massing model", "Downloadable IFC file"],
    thumbnail: "https://picsum.photos/seed/wf18/600/400",
    tileGraph: {
      nodes: [
        {
          id: "n1",
      ...
      edges: [
        ...
        { id: "e3-4", source: "n3", sourceHandle: "geo-out", target: "n4", targetHandle: "geo-in", type: "animatedEdge" },
      ],
    },
  },
  {
    id: "wf-05",
    name: "Floor Plan → Interactive 3D Model",
    description:
  ...
  {
    id: "wf-04",
    name: "Parameters → 3D Massing + IFC Export",
    description:
