  ...
  return (
    <select
      ...
      style={{
        ...
        border: isLight ? "1px solid rgba(15, 20, 25, 0.10)" : "1px solid rgba(255,255,255,0.14)",
        borderRadius: 6,
        fontSize: 12,
        fontWeight: 500,
        color: isLight ? "#0F1419" : "#E6E9F0",
        cursor: "pointer",
        outline: "none",
        letterSpacing: "0.01em",
      }}
      onFocus={(e) => {
        (e.currentTarget as HTMLSelectElement).style.borderColor = isLight ? "rgba(37,99,235,0.4)" : "rgba(0,245,255,0.4)";
      }}
      onBlur={(e) => {
        (e.currentTarget as HTMLSelectElement).style.borderColor = isLight ? "rgba(15, 20, 25, 0.10)" : "rgba(255,255,255,0.14)";
      }}
    >
