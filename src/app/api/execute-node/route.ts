...
// Canvas Unification (2026-05-17): GN-013 removed, replaced by the
// 4-node decomposition TR-025 → TR-026 → TR-027 → EX-007 (see
// PHASE_CANVAS_UNIFICATION_2026-05-17.md). v2 nodes TR-022/TR-024/
...
const REAL_NODE_IDS = new Set(["TR-001", "TR-003", "TR-004", "TR-005", "TR-012", "GN-001", "GN-003", "GN-004", "GN-007", "GN-008", "GN-009", "GN-010", "GN-011", "GN-012", "TR-007", "TR-008", "TR-013", "TR-014", "TR-015", "TR-016", "TR-022", "TR-024", "TR-025", "TR-026", "TR-027", "TR-028", "TR-029", "TR-030", "TR-031", "TR-032", "TR-034", "EX-001", "EX-002", "EX-003", "EX-006", "EX-007"]);
