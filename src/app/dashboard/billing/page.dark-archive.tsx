/**
 * DARK ARCHIVE — Original dark-themed billing page from Z.6.x.
 *
 ...
 * 3. Remove /dashboard/billing from isLightSurface in
 *    src/app/dashboard/layout.tsx
 *
 * Last active: 2026-05-02
 * Z.7.1 redesign: feat/billing-render-studio-light
 */
