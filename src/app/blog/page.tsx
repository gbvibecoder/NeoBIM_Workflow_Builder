        ...
        <article className="relative z-10" style={{
          ...
          <Reveal>
            <p>
              ...
              The pricing starts at free — one lifetime execution to try the platform — and goes up to ₹1,999/month for the
              pro tier with 45 workflows + executions and priority support.
            </p>
          </Reveal>
