...
export const PREBUILT_WORKFLOWS: WorkflowTemplate[] = [
  ...
  {
    id: "wf-14",
    name: "Detailed PDF → Ultra-Realistic 3D",
    description:
      "Upload a detailed PDF brief → parse, extract requirements, analyze design intent, generate multi-view ultra-detailed renders, then reconstruct a hyper-detailed textured 3D model (GLB). Render-first pipeline for maximum visual fidelity.",
    tags: ["pdf", "concept", "render", "3d", "ultra-realistic", "hi-fi", "full-pipeline", "brief"],
    category: "Concept Design",
    complexity: "advanced",
    ...
    expectedOutputs: [
      ...
      "Multi-view ultra-detailed concept renders",
      "Hyper-detailed textured 3D model (GLB)",
      "360° preview",
    ],
    ...
    tileGraph: {
      ...
      edges: [
        ...
        { id: "e5-6a", source: "n5", sourceHandle: "images-out", target: "n6", targetHandle: "images-in", type: "animatedEdge" },
        { id: "e4-6b", source: "n4", sourceHandle: "text-out", target: "n6", targetHandle: "desc-in", type: "animatedEdge" },
      ],
    },
  },
  {
