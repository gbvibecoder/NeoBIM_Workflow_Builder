...
export const PREBUILT_WORKFLOWS: WorkflowTemplate[] = [
  ...
  {
    id: "wf-14",
    name: "Detailed PDF → Concept Render",
    description:
      "Upload a detailed PDF brief → parse, extract requirements, analyze design intent, generate 3D massing, and produce concept renders — end-to-end from document to visualization.",
    tags: ["pdf", "concept", "render", "full-pipeline", "massing", "brief"],
    category: "Concept Design",
    complexity: "advanced",
    estimatedRunTime: "~3 minutes",
    ...
    expectedOutputs: [
      ...
      "3D massing model with KPIs",
      "Concept architectural renders",
    ],
    ...
    tileGraph: {
      ...
      edges: [
        ...
        { id: "e4-5", source: "n4", sourceHandle: "prog-out", target: "n5", targetHandle: "req-in", type: "animatedEdge" },
        { id: "e5-6a", source: "n5", sourceHandle: "geo-out", target: "n6", targetHandle: "ctrl-in", type: "animatedEdge" },
        { id: "e4-6b", source: "n4", sourceHandle: "text-out", target: "n6", targetHandle: "prompt-in", type: "animatedEdge" },
      ],
    },
  },
  {
