        ...
        headers: [
          {
            ...
            value: `
              ...
              connect-src 'self' blob: data: https://api.openai.com https://api.stability.ai https://*.upstash.io https://api.stripe.com https://api.razorpay.com https://*.razorpay.com https://lumberjack.razorpay.com https://api.klingai.com https://*.klingai.com https://*.fal.ai https://fal.run https://www.facebook.com https://connect.facebook.net https://*.r2.cloudflarestorage.com https://www.google-analytics.com https://analytics.google.com https://*.google-analytics.com https://*.googletagmanager.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://td.doubleclick.net https://stats.g.doubleclick.net https://www.clarity.ms https://*.clarity.ms ${R2_CDN_BASE};
              frame-src 'self' blob: https://js.stripe.com https://api.razorpay.com https://checkout.razorpay.com https://www.googletagmanager.com;
