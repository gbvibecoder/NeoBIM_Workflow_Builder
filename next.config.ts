...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const scriptSrc = "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://js.stripe.com https://checkout.razorpay.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://connect.facebook.net https://www.googletagmanager.com https://www.google-analytics.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://www.clarity.ms blob: data:";
        ...
        headers: [
          {
            ...
            value: `
              ...
              img-src 'self' blob: data: https://oaidalleapiprodscus.blob.core.windows.net https://picsum.photos https://images.unsplash.com https://lh3.googleusercontent.com https://*.vercel.app https://*.trybuildflow.in https://www.facebook.com https://www.google-analytics.com https://www.googletagmanager.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://www.google.com https://www.google.co.in https://www.clarity.ms https://pub-27d9a7371b6d47ff94fee1a3228f1720.r2.dev https://i.ibb.co;
              font-src 'self' https://fonts.gstatic.com data:;
              media-src 'self' blob: data: https://*.klingai.com https://*.kuaishou.com https://*.ksyun.com https://*.ks-cdn.com https://*.kscampus.com https://*.trybuildflow.in https://*;
              connect-src 'self' blob: data: https://api.openai.com https://api.stability.ai https://*.upstash.io https://api.stripe.com https://api.razorpay.com https://*.razorpay.com https://lumberjack.razorpay.com https://api.klingai.com https://*.klingai.com https://*.fal.ai https://fal.run https://www.facebook.com https://connect.facebook.net https://*.r2.cloudflarestorage.com https://*.s3.ap-south-1.amazonaws.com https://*.trybuildflow.in https://www.google-analytics.com https://analytics.google.com https://*.google-analytics.com https://*.googletagmanager.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://td.doubleclick.net https://stats.g.doubleclick.net https://www.clarity.ms https://*.clarity.ms ${R2_CDN_BASE};
              frame-src 'self' blob: https://js.stripe.com https://api.razorpay.com https://checkout.razorpay.com https://www.googletagmanager.com https://*.trybuildflow.in;
